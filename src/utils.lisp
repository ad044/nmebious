...
(defun define-static-resource (uri path)
  (push
   (hunchentoot:create-static-file-dispatcher-and-handler uri path)
...
(defmacro with-submit-text (&body body)
...
(defmacro with-submit-file (&body body)
            ...
            (cond ((eql ,type 'api)
                  ...
                  ((eql ,type 'web-view)
                   (progn
                     ...
                     (setf (hunchentoot:session-value :flash-message) e)
